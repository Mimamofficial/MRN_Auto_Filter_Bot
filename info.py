...
# FORCE_SUB 
auth_req_channel = environ.get('AUTH_REQ_CHANNEL', '-1002232443823')  # requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
AUTH_CHANNELS = [int(channels_id) for channels_id in environ.get('AUTH_CHANNELS', '-1002745555397').split() if re.match(r'^-?\d+$', channels_id)]  # Channels for force sub (make sure bot is admin)
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/MRN_Tutorial/1814")   # Second tutorial link for verification
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "1b8e94e97189da28b35fcab06c0850bd92569751")  # Shortener API key for second website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movies_Tv_Serial_Request') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/mimam_officialx') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/MRN_RIPPER') # Update channel link for the bot
