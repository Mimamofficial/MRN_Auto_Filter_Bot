...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002671493516 -1002670141750 -1002268363111').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002338765286'))  # Log channel id (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/5ns27j.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '<code>Mrn-Officialx@axl</code>')    # Owner UPI ID for payments
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002275478487'))  # Notification of sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+T5B4zp8-Wjg5MTU9') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/mimam_officialx') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Mrn_Officialx') # Update channel link for the bot
...
if HAS_SSL:
    URL = "https://mrn-auto-filter-bot-d5869d42.koyeb.app/".format(FQDN)
else:
    URL = "https://mrn-auto-filter-bot-d5869d42.koyeb.app/".format(FQDN)
